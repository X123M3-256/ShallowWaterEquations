...
from tests import dam_break,do_dam_break_computation,do_convergence_test,do_smooth_convergence_test,do_conservation_test,do_total_variation_test
...
do_dam_break_computation(solvers)
